#recognize based on the face and clothes
#person in moujoud f captured_images
#person out moujoud f backpic ;)
...
# Function to load and process all images from the training folder (captures_images)
def load_and_process_images(captures_folder):
    # Ask user for the name of the person to train the model on
    ...
    for filename in processed_images:
        ...
        # Assuming the images are for the same person and we don't need to check filenames here
...
# Step 1: Check if there are new images in 'captures_images' folder and process them (only if needed)
load_and_process_images(captures_folder)
